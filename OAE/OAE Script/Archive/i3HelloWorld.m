...
% Start the pump (Pressure target[daPa], speed[daPa/s], Pressure target tolerence[daPa])
helloWorld.SetPressure(-100, 100, 10);

pause(2); % Wait until time is completed.

% Change stimuli (frequency[Hz], amplitude[mV], length of stimuli[n])
helloWorld.ChangeStimulation(226*2,100,390);
