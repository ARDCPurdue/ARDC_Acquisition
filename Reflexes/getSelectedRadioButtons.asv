...
fig = figure('Name', 'Enter Results', 'NumberTitle', 'off', ...
    'Position', [100, 100, 1200, 800],'Units','Normalized');
% yheight orig = 550
...
%% Adding features for WRS, ACT, and Binaural QickSIN
...
%% Binaural QuickSin
QSinPanel = uipanel('Title', 'Binaural QuickSIN', ...
    'Position',  [0.05 0.72 0.9 0.07], ...
    'FontSize', 14); 
%QSin_Label, QSin_Score, QSin_Label_Level, QSin_Level, QSin_LabelDNT, QSin_checkDNT

QSin_Label = uicontrol('Style', 'text', 'Parent', QSinPanel, 'String', 'Score:', ...
    'Position', [120 5 50 20], 'HorizontalAlignment', 'Right', ...
    'FontSize', 12);
QSin_Score = uicontrol('Style', 'edit', 'Parent', QSinPanel, ...
    'Position', [175 5 40 20], ...
    'FontSize', 12);
QSin_Label_Level = uicontrol('Style', 'text', 'Parent', QSinPanel, 'String', 'Level:', ...
    'Position', [270 5 50 20], 'HorizontalAlignment', 'Right', ...
    'FontSize', 12);
QSin_Level = uicontrol('Style', 'edit', 'Parent', QSinPanel, ...
    'Position', [325 5 40 20], ...
    'FontSize', 12);
QSin_LabelDNT = uicontrol('Style', 'text', 'Parent', QSinPanel, 'String', 'Did not test:', ...
    'Position', [425 5 150 20], 'HorizontalAlignment', 'Right', ...
    'FontSize', 12);
QSin_checkDNT = uicontrol('Style', 'checkbox', 'Parent', QSinPanel, 'Value', 0, ...
    ...
    function radioButtonCallback(~, ~, rowIndex, colIndex, levels, cond)
        ...
        updateButton = uicontrol('Style', 'pushbutton', 'String', 'Update Matrix', ...
            ...
            'Callback', @(~, ~) updateAndPrint(levels, ...
                ...
                QSin_Score, QSin_Level, QSin_checkDNT,...
...
% Function to update and print the matrix
    function updateAndPrint(levels, ...
        ...
        if get(QSin_checkDNT, "Value") == 0
            output_QuickSIN.Score = get(QSin_Score, "String");
            output_QuickSIN.Level = get(QSin_Level, "String");
        else
            output_QuickSIN.DNT = get(QSin_checkDNT, "Value");
        end
        ...
        ACTscore = {get(act_Score1, 'String'); get(act_Score2, 'String')};
        output_act.score = ACTscore; 
        output_act.couldNotTest = couldNotTest; 
        output_act.didNotTest = didNotTest; 
